...
try
{
    __CollectEventCallbacks(this, "OnGameEvent_", "DanyriaAddonGameEventCallbacks_mapspawn", RegisterScriptGameEventListener);
    printl("[DHUD] addon direct event callbacks registered: mapspawn");
}
catch(e)
{
