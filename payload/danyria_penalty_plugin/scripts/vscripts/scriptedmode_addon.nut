...
try
{
    __CollectEventCallbacks(this, "OnGameEvent_", "DanyriaAddonGameEventCallbacks_scriptedmode", RegisterScriptGameEventListener);
    printl("[DHUD] addon direct event callbacks registered: scriptedmode");
}
catch(e)
{
